...
######################################################################################################
######################################################################################################
# Andrius : Both classes below are modified versions of the original classes you wrote. I have fixed the 
# normalization issues within the likelihood function, and also allowed for the flexible use of the
...
######################################################################################################
######################################################################################################
# Andrius : Double check that all VI inits are as they should be. 
######################################################################################################
######################################################################################################
######################################################################################################
